...
## Тест-кейс 2: Просмотр участия в мероприятиях

Шаги:

1. Войти в аккаунт.
2. Нажать на кнопку "Личный кабинет" в нижней панели навигации.

Ожидаемый результат:

Пользователь видит информацию о себе, а так же список мероприятий на которые он зарегестрирован.

## Тест-кейс 3: Создание мероприятия

Шаги:

1. Войти в аккаунт как вожатый.
2. Перейти на вкладку "Мероприятия" в нижней панели навигации.
3. Нажать на кнопку "Плюс".
4. Заполнить форму.
5. Нажать кнопку отправить.

Ожидаемыей результат:

Во вкладке мероприятия добавиться новое мероприятие с указанной в форме информацией.

## Тест-кейс 4: Принятие заявки

Шаги: 

1. Войти в аккаунт как вожатый.
2. Перейти на вкладку "Мероприятия" в нижней панели навигации.
3. Нажать на одно из созданных данным пользователем мероприятий.
4. Нажать имя одного из людей в разделе "Заявки"
5. В открывшемся профиле нажать кнопку "Принять"

Ожидаемый результат: 

Выбранный человек пропадет из списка заявок и появится в списке участников.

## Тест-кейс 5: Начисление баллов
...
2. Перейти на вкладку "Мероприятия" в нижней панели навигации.
3. Нажать на одно из созданных данным пользователем мероприятий.
4. В разделе "Участники" ввести в форму колличество баллов(до 100).
5. Нажать на профиль участника.

Ожидаемый результат:

В профиле выбранного пользователя будут увеличено колличество очков на введеное колличество баллов.
